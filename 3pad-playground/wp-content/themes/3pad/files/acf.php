    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'default_value' => 'Let\'s Start Here!',
                'maxlength' => 50,
                'allow_in_bindings' => 1,
            ...
            array(
                ...
                'aria-label' => '',
                'type' => 'color_picker',
                'instructions' => 'This will change the site\'s viewport & mobile theme color.<br>You can see the changes depending on browser (Mobile).',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
            ...
            array(
                'key' => 'field_64aadb38412eb',
                'label' => 'Custom Domain',
                'name' => 'custom_domain',
                'aria-label' => '',
                'type' => 'url',
                'instructions' => 'Enter your custom domain here.<br>
Be sure to start URL with https://',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
...
<button style="background: red ; border: 1px solid; " class="export-btn template-button" data-template-id="reset-template">Reset</button>',
                        'new_lines' => 'wpautop',
                        'esc_html' => 0,
                    ),
                ),
...
H300px',
            ...
            array(
                ...
                'aria-label' => '',
                'type' => 'select',
                'instructions' => 'This will show a prompt to all users before viewing your page\'s content.<br>The user will have to be age 18+ to view the content.<br>⚠️ If issues arise test on different browser. ⚠️',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
...
<button id="export-btn"	class="export-btn">Export</button>',
                    ...
                    array(
                        ...
                        'message' => 'This will export your site to a .html file.

<!-- Download Button -->
		<button id="download-btn" class="import-btn">Download Site</button>',
                        'new_lines' => 'wpautop',
                        'esc_html' => 0,
                    ),
                    array(
                    ...
                    array(
                        ...
                        'message' => 'This will extract configuration settings directly from another website. 
<br>
Enter Website URL you\'d like to extract.

<!-- Import Field -->
		<textarea id="import-fields-url" rows="1" placeholder="example.com"></textarea>
<!-- Import Button -->
		<button id="import-url-btn" class="import-btn" style="background: #ffffff4f; box-shadow: 0 0 20px 10px #67665b9c;">Clone Site</button>',
                        'new_lines' => 'wpautop',
                        'esc_html' => 0,
                    ),
                    array(
                        ...
                        'message' => 'This will import any saved configuration settings . These settings can be found in the exported ‘.txt’ file or from extracting a URL
...
<!-- Import Button -->
		<button id="import-btn" class="import-btn">Import Settings</button>',
                        'new_lines' => 'wpautop',
                        'esc_html' => 0,
                    ),
                ),
            ...
            array(
                ...
                'message' => 'First export your site & then upload the file (.html) to any of the options below.
<br>
<div class="image-publishing" style="flex-direction: row; flex-wrap: wrap; gap: 10px; justify-content: center; width: 100%; max-width: 1000px; margin: 0 auto; display: flex !important; ">
		...
		<a target="_blank" href="https://example.com/image3" style="flex: 1; min-width: 200px; box-sizing: border-box;">
				<img src="/wp-content/themes/3pad/assets/images/statichost.png" alt="Image 3" style="width: 100%; height: auto; display: block;">
		</a>
</div>',
                'new_lines' => 'wpautop',
                'esc_html' => 0,
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'aria-label' => '',
                'type' => 'url',
                'instructions' => 'Paste image URL here.<br>It should end with file type .jpg, .png etc<br>Must start With https://<br> You can upload images <a target="_blank" href="https://postimages.org" style="font-weight: bold;color: yellow;text-decoration: none;">HERE</a>',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
                ...
                'default_value' => 'https://bafkreihcwfdhbu6fnff25ng7ktzp6lpzuqh2po7vdvnqjvid6rpdc4l234.ipfs.flk-ipfs.io',
                'allow_in_bindings' => 1,
                'placeholder' => '',
            ),
            array(
            ...
            array(
                ...
                'aria-label' => '',
                'type' => 'text',
                'instructions' => 'Vimeo - https://vimeo.com/<b>55073825</b> <-- This is your video URL<br>Youtube - https://www.youtube.com/watch?v=<b>17ntdUP5-Do</b> <-- This is your video URL',
                'required' => 0,
                'conditional_logic' => array(
                    array(
                        array(
...
<br>Choose from Chats or Embedded content such as video, audio & more.',
            ...
            array(
                ...
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => 'Need Help Getting Code? <a target="_blank" href="https://iframely.com/try" style="color: yellow;">Generate Code Here</a>.
<br>Must start with https://',
            ...
            array(
                'key' => 'field_646167922f9c4',
                'label' => 'Custom Content',
                'name' => 'enable_iframe_content_1',
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 0,
...
<br>Must start with https://',
            ...
            array(
                'key' => 'field_646169172f9c6',
                'label' => 'Custom Content',
                'name' => 'enable_iframe_content_3',
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 0,
...
<br>Must start with https://',
            ...
            array(
                'key' => 'field_6461692c2f9c7',
                'label' => 'Custom Content',
                'name' => 'enable_iframe_content_6',
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 0,
...
<br>Choose from Chats or Embedded content such as video, audio & more.',
                ...
                'choices' => array(
                    ...
                    'comments-button' => 'Chat - (Discord, Telegram or Disqus)',
                    'embed10-content' => 'Custom Content',
                ),
                'default_value' => false,
                'return_format' => 'value',
                'multiple' => 0,
...
<br>Must start with https://',
            ...
            array(
                'key' => 'field_646169382f9c8',
                'label' => 'Custom Content',
                'name' => 'enable_iframe_content_10',
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 0,
...
<br>Must start with https://',
            ...
            array(
                'key' => 'field_646169452f9c9',
                'label' => 'Custom Content',
                'name' => 'enable_iframe_content_2',
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 0,
...
<br>Must start with https://',
            ...
            array(
                'key' => 'field_646169542f9ca',
                'label' => 'Custom Content',
                'name' => 'enable_iframe_content_4',
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 0,
...
<br>Must start with https://',
            ...
            array(
                'key' => 'field_6461695e2f9cb',
                'label' => 'Custom Content',
                'name' => 'enable_iframe_content_5',
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 0,
...
<br>Must start with https://',
            ...
            array(
                'key' => 'field_6461696c2f9cc',
                'label' => 'Custom Content',
                'name' => 'enable_iframe_content_7',
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 0,
...
<br>Must start with https://',
            ...
            array(
                'key' => 'field_646169772f9cd',
                'label' => 'Custom Content',
                'name' => 'enable_iframe_content_8',
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 0,
...
<br>Must start with https://',
            ...
            array(
                'key' => 'field_646169802f9ce',
                'label' => 'Custom Content',
                'name' => 'enable_iframe_content_9',
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 0,
