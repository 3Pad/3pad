...
add_action( 'acf/include_fields', function() {
	...
	'fields' => array(
		...
		array(
			...
			'default_value' => 'Get Started Here!',
			'maxlength' => 50,
			'allow_in_bindings' => 1,
		...
		array(
			...
			'label' => 'Custom Domain (Check For Updates)',
			'name' => 'custom_domain',
			'aria-label' => '',
			'type' => 'url',
			'instructions' => 'Enter your custom domain here.<br>
Be sure to start URL with https://
This also allows your website to stay current on any new updates.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
...
<button id="export-btn"	class="export-btn">Export</button>',
				...
				array(
					...
					'message' => 'This will export your site to a .zip file.
...
<!-- Import Button -->
		...
		array(
			...
			'message' => 'First export your site & then upload the file (.zip) to any of the options below.
<br>
<div class="image-publishing" style="flex-direction: row; flex-wrap: wrap; gap: 10px; justify-content: center; width: 100%; max-width: 1000px; margin: 0 auto; display: flex !important; ">
		<a target="_blank" href="https://tiiny.host" style="flex: 1; min-width: 200px; box-sizing: border-box;">
				<img src="/wp-content/themes/3pad/assets/images/tinyhost.png" alt="Image 1" style="width: 100%; height: auto; display: block;">
		</a>
		<a target="_blank" href="https://static.app" style="flex: 1; min-width: 200px; box-sizing: border-box;">
				<img src="/wp-content/themes/3pad/assets/images/static.png" alt="Image 2" style="width: 100%; height: auto; display: block;">
		</a>
		<a target="_blank" href="https://statichost.host" style="flex: 1; min-width: 200px; box-sizing: border-box;">
	...
	'fields' => array(
		...
		array(
			...
			'aria-label' => '',
			'type' => 'text',
			'instructions' => 'Paste image URL here.<br>Make sure it Ends with file type .jpg, .png etc<br>Must start With https://<br> You can upload images <a target="_blank" href="https://postimages.org" style="font-weight: bold;color: yellow;text-decoration: none;">HERE</a>',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
				'class' => '',
				'id' => 'background-base64',
			),
			'default_value' => 'https://5qwlajy5ijq3uqfpgjigtksvzrzkqj5agkhlzeu7q75d5vgamcpq.ar-io.dev/7CywJx1CYbpArzJQaapVzHKoJ6AyjrySn4f6PtTAYJ8?',
			'maxlength' => '',
			'allow_in_bindings' => 1,
