...
////import Function
function importFields(jsonString, textInput) {
    if (!jsonString && textInput) {
...
// Loop through each template button and add a click event listener
templateButtons.forEach(function (button) {
  button.addEventListener("click", function (event) {
    ...
    // Call the importFields function with the JSON string as a parameter
