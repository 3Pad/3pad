...
function restrict_access()
{
  ...
  if (!current_user_can('administrator')) {  // //Admin Only
    if (
      ($URI == ($basepath . '/options-general.php?page=unlock-protocol')) ||
      ($URI == ($basepath . '/options-privacy.php')) ||
      ($URI == ($basepath . '/options-permalink.php')) ||
      ($URI == ($basepath . '/options-media.php')) ||
      // ($URI ==($basepath . '/options-discussion.php'))
      ($URI == ($basepath . '/options-reading.php')) ||
      ($URI == ($basepath . '/options-writing.php')) ||
      ($URI == ($basepath . '/options-general.php')) ||
      ($URI == ($basepath . '/options.php')) ||
      ($URI == ($basepath . '/themes.php')) ||
      ($URI == ($basepath . '/nav-menus.php')) ||
      ($URI == ($basepath . '/admin.php?page=elementor')) ||
      ($URI == ($basepath . '/edit.php?post_type=elementor_font')) ||
      ($URI == ($basepath . '/edit.php?post_type=elementor_icons')) ||
      ($URI == ($basepath . '/admin.php?page=elementor-system-info')) ||
      ($URI == ($basepath . '/admin.php?page=elementor-license')) ||
      ($URI == ($basepath . '/edit.php?post_type=acf-field-group')) ||
      ($URI == ($basepath . '/post-new.php?post_type=acf-field-group')) ||
      ...
      ($URI == ($basepath . '/admin.php?page=uip-overview')) ||
      ($URI == ($basepath . '/admin.php?page=uip-content')) ||
